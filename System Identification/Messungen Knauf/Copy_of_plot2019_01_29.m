...
p41=subplot(3,1,1)
plot(DatumUhrzeit,BL,DatumUhrzeit,Kohle,'LineWidth',2)
grid on
legend("Bl [%]","Kohle[%]",'Location','southwest')
axis tight

p42=subplot(3,1,2)
plot(DatumUhrzeit,BL./Kohle,'LineWidth',2)
grid on
legend("Verhältnis Brennerleistung zu Kohle ",'Location','southwest')
axis tight

p43=subplot(3,1,3)
plot(DatumUhrzeit,KohleISTKgh,DatumUhrzeit,KohleSOLLKgh,'LineWidth',2)
grid on
legend("KohleISTKgh[kgh]","KohleSOLLKgh[Kgh]",'Location','southwest')
axis tight


linkaxes([p41,p42,p43],'x')
